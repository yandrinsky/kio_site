export const QUERY_KEYS = {
    ...
    SEARCH_USER: '/SEARCH_USER_QUERY',

    CREATE_TASK: '/CREATE_TASK_QUERY',
    DELETE_TASK: '/DELETE_TASK_QUERY',
    UPDATE_TASK: '/UPDATE_TASK_QUERY',
    APPROVE_TASK: '/APPROVE_TASK_QUERY',
    UPLOAD_TASK_SOURCE: '/UPLOAD_TASK_SOURCE_QUERY',
    ...
    GET_WINNERS_LIST: '/GET_WINNERS_LIST_QUERY',
    BAN_SOLUTION: '/BAN_SOLUTION_QUERY',
    GET_TASK: '/GET_TASK_QUERY',
    GET_NOT_APPROVED_TASKS_LIST: '/GET_NOT_APPROVED_TASKS_LIST_QUERY',
    GET_CREATED_TASKS_LIST: '/GET_CREATED_TASKS_LIST_QUERY',
    GET_MY_TASKS_LIST: '/GET_MY_TASKS_LIST_QUERY',
    START_TASK: '/START_TASK_QUERY'
};
