        ...
        <section className={css.title}>
            <div className={css['title__text-wrapper']}>
                {TITLE.map((el, i) => (
                    ...
                    >
                        <span
                            className={clx(css['title__text-content'], css['title__text-content-' + (i + 1)])}
                        >
                            {el}
                        </span>
                    </span>
            ...
            <p className={css.title__description}>
                КИО — это конкурс, который позволяет вам раскрыть ваши таланты, попробовать множество
                интересных задач и соревноваться с друзьями
            </p>
