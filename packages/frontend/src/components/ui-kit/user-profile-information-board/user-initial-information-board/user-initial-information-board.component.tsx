...
export const UserInitialInformationBoard: FC<PropsWithChildren<IUserInitialInformationBoard>> = ({
  title,
  iconSrc,
  children
}) => {
  return (
    <div className={css[`initial-information-board__container`]}>
      ...
      <div className={css[`initial-information-board__info`]}>{children}</div>
    </div>
  );
};
